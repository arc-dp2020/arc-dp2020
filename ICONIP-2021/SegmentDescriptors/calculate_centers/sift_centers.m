...
fprintf('Inside function SegmentDescriptors> calculate_centres >sift_centers\n'); 

SIFTparam.grid_spacing = 1;
SIFTparam.patch_size = 16;
[uV sV] = memory;
%use 10% avalible memory if its smaller than the default
ndata_max = min(sV.PhysicalMemory.Available/512/10,100000);
